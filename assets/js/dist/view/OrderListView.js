...
System.register(['./View', '../helper/DateHelper', '../controller/OrderController'], function (_export, _context) {
    "use strict";

    var View, DateHelper, orderController, _createClass, OrderListView;
    ...
    return {
        ...
        }, function (_controllerOrderController) {
        ...
        execute: function () {
            ...
            _export('OrderListView', OrderListView = function (_View) {
                ...
                function OrderListView(element) {
                    ...
                    var _this = _possibleConstructorReturn(this, (OrderListView.__proto__ || Object.getPrototypeOf(OrderListView)).call(this, element));
